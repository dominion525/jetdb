...
mod tests {
    ...
    fn decimal_variant_zero() {
        let bytes = [0x0e, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];
    ...
    fn decimal_variant_clean_division_scale_unchanged() {
        ...
        let bytes = [0x0e, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];
    ...
    fn decimal_variant_scale_bump_positive() {
        ...
        let bytes = [0x0e, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x67, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];
    ...
    fn decimal_variant_scale_bump_negative() {
        ...
        let bytes = [0x0e, 0x00, 0x03, 0x80, 0x00, 0x00, 0x00, 0x00, 0x67, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];
        assert_eq!(decimal_variant_to_string(&bytes), "-0.615");
    }
    ...
    fn decimal_variant_deeper_scale_bump() {
        ...
        let bytes = [0x0e, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x25, 0xa1, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00];
    ...
    fn decimal_variant_large_magnitude() {
        ...
        let bytes = [0x0e, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0xfb, 0xff, 0xf3, 0x44, 0x82, 0x91, 0x63, 0x45];
